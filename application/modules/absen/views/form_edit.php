...
$(document).ready(function(){
	...
	$("#nis").keyup(function(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>absen/DataSiswa",
			data	: "cari="+cari,
			cache	: false,
			success	: function(data){
	...
	$("#simpan").click(function(){
			        ...
			        var ijin=$("#ijin").val();
				var alpha=$("#alpha").val();
                                var lambat=$("#lambat").val();
                                var dispensasi=$("#dispensasi").val();
		...
		if(nis.length==0){
			...
			$.messager.show({
				title:'Info',
				msg:'Maaf, Semester tidak boleh kosong', 
				timeout:2000,
				showType:'show'
			});
			$("#semester").focus();
...
<tr>
	<td colspan="3" align="center">
      <button type="button" name="simpan" id="simpan" class="easyui-linkbutton" 
            ...
            <a href="<?php echo $base_url; ?>absen/<?php echo $kelas;?>">
