...
<a href="<?php echo base_url();?>absen/input2/<?php echo $this->uri->segment(3); ?>">
    <button type="button" name="tambah" id="tambah" class="easyui-linkbutton" 
            data-options="" style="background:#009df9 "><strong>Input Absen Semester II </strong></button>
</a>
<a href="<?php echo base_url();?>absen/absenGanjil/<?php echo $this->uri->segment(3);  ?>">
<button type="button" name="refresh" id="refresh" class="easyui-linkbutton" 
        data-options=""style="background:#CFFEF0 ">Lihat Semester I </button>
</a>
