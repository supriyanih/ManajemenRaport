...
$(document).ready(function(){
	...
	$("#nis").keyup(function(){
        ...
        $("#harian").keypress(function(data){
		if (data.which!=8 && data.which!=0 && (data.which<48 || data.which>57)) {
			return false;
		}
	});
        $("#uts").keypress(function(data){
		if (data.which!=8 && data.which!=0 && (data.which<48 || data.which>57)) {
			return false;
		}
	});
        $("#uas").keypress(function(data){
		if (data.which!=8 && data.which!=0 && (data.which<48 || data.which>57)) {
			return false;
		}
	});
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>nilai/DataSiswa/"+kls,
			data	: "cari="+cari,
			cache	: false,
			success	: function(data){
...
<tr>    
	<td>Kelas</td>
    <td width="5">:</td>
    <td><input type="text" name="kls" id="kls" readonly="readonly" 
