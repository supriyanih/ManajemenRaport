...
<a href="<?php echo base_url();?>super/tambah">
...
<div style="float:left; padding-bottom:5px;">
<form name="form" method="post" action="<?php echo base_url();?>super">
...
<?php
	if($data->num_rows()>0){
		...
		foreach($data->result_array() as $db){ 
                    $tgl = $this->mdl_super->tgl_indo($db['tgl_lahir']);
		?>    
    	<tr>
	    ...
	    <td align="center" width="100"><?php echo $db['nip']; ?></td>
            ...
            <a href="<?php echo base_url();?>super/edit/<?php echo $db['nip'];?>">
			<img src="<?php echo base_url();?>asset/images/ed.png" title='Edit'>
			</a>
            <a href="<?php echo base_url();?>super/hapus/<?php echo $db['nip'];?>"
